...
$\delta=0$. In fact, with this choice of $\delta$ it is easy to see that the prediction $w_t$ in line 4 of Algorithm~\ref{algorithm:ftrl-varying-regularizer} would be indipendent of the scaling of the $\ell_t$.  
