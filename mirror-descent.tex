...
\cite{Nemirovski-Yudin-1983} and later analyzed in~\cite{Beck-Teboulle-2003}.}
...
\textsc{AdaGrad}~\cite{Duchi-Hazan-Singer-2011} (see
also~\cite{Duchi-Shalev-Shwartz-Singer-Tewari-2010,Rakhlin-Sridharan-2013}) we
can upper bound regret of \textsc{Scale-Free Mirror Descent}.  Proof is
...
depend on $\sup_{u \in K} f(u)$.  Similarly, regret bound in
Theorem~\ref{theorem:regret-scale-free-mirror-descent} for \textsc{Scale-Free
Mirror Descent} depends on $\sup_{v \in K} \Breg_R(u,v)$ and regret bounds in
