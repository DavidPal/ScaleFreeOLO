...
Leader} comes from~\cite{Abernethy-Hazan-Rakhlin-2008}. Independently, the
algorithm was proposed by~\cite{Nestorov-2009} under the name \textsc{Dual
Averaging} and was later anlyzed in~\cite{Xiao-2010}.} (\textsc{FTRL})
algorithm with varying regularizers, presented as
...
Proof of the lemma can be found in~\cite{Orabona-Crammer-Cesa-Bianchi-2014}.
