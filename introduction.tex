...
examples that demonstrate variants of \textsc{MD} can have $\Omega(T)$ regret
(on sequences of loss vector of unit norm) if the Bregman divergence associated
with the regularizer is unbounded.  First example demonstrates
