\section{Proofs for Mirror Descent}
...
\end{align*}
The last equality follows by from definition of Bregman divergence.  Summing
over all $t=1,2,\dots,T$ we get the final regret bound.
\end{proof}
